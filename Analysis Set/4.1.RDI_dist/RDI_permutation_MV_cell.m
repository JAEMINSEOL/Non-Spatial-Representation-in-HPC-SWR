...
ROOT.Rip = [ROOT.Save '\ripples_mat\R5_cell'];
...
for rid=1:size(RipplesTable_p,1)
    ...
    thisReact_B = ReactTable(strcmp(ReactTable.RippleID,RipID),:);
    ...
    thisUnits_Sig_L = thisUnits(thisUnits.Selectivity_LScene>=1 & thisUnits.Selectivity_LScene<4 & abs(thisUnits.RDI_LScene)>0.1,:);
    thisUnits_Sig_R = thisUnits(thisUnits.Selectivity_RScene>=1 & thisUnits.Selectivity_RScene<4 & abs(thisUnits.RDI_RScene)>0.1,:);
    thisUnits_Sig_C = thisUnits(thisUnits.Selectivity_LR>=1 & thisUnits.Selectivity_LR<4 & abs(thisUnits.RDI_LR)>0.1,:);

    thisPool_A_Sig_L =  thisPool_A(thisPool_A.Selectivity_LScene>=1 & thisPool_A.Selectivity_LScene<4,:);
    thisPool_A_Sig_R = thisPool_A(thisPool_A.Selectivity_RScene>=1 & thisPool_A.Selectivity_RScene<4,:);
    thisPool_A_Sig_C =  thisPool_A(thisPool_A.Selectivity_LR>=1 & thisPool_A.Selectivity_LR<4,:);
