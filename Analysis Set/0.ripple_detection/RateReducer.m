function RateReducer(thisRID, thisSID, RawROOT, SaveROOT,FileType)
...
if ~exist([RawROOT '\rat' thisRID '-' thisSID '\' FileType num2str(thisCSCID) '.ncs']), continue; end
cscData_raw = loadCSC_fromRawData(cscID, RawROOT, '', Params.exportMODE, Params.behExtraction,FileType);
...
cscData_reduced.Header(15) = {['-ADBitVolts ' num2str(cscData_raw.ADBitVolts)]};
cscData_reduced.Header(16) = {['-ADMaxValue ' num2str(cscData_raw.ADMaxValue)]};
