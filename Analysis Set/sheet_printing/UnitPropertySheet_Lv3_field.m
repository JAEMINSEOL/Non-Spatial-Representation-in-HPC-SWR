...
ROOT.Fig = [ROOT.Mother '\Processed Data\units_mat\ProfilingSheet\U3'];
...
xlim([0 30]); ylim([0 mx*1.5])
        ...
        settick(stem_end_index,max(Maps.skaggsMap1D{1}))
        title('overall')
        %% left
        subplot(3,2,2)
        hold on
